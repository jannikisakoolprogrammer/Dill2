...
define(
	...
	"Click here to manage PHP files of the website.");
...
define(
	"DILL2_TEXT_WXMANAGETEMPLATESDIALOG_WXBUTTON_ASSIGNPHPFILES",
	"Assign PHP files");
...
define( "DILL2_TEXT_WXMANAGEPHPFILESDIALOG_WXBUTTON_ADDPHPFILE", "Add PHP file" );
define( "DILL2_TEXT_WXMANAGEPHPFILESDIALOG_WXBUTTON_RENAMEPHPFILE", "Rename PHP file" );
define( "DILL2_TEXT_WXMANAGEPHPFILESDIALOG_WXBUTTON_DELETEPHPFILE", "Remove PHP file" );
define( "DILL2_TEXT_WXMANAGEPHPFILESDIALOG_WXBUTTON_ADDPHPFILE_WXDIALOG_MESSAGE", "Please type in a valid filename, including the .'php' extension." );
define( "DILL2_TEXT_WXMANAGEPHPFILESDIALOG_WXBUTTON_ADDPHPFILE_WXDIALOG_CAPTION", "Create and add a new PHP file" );
define( "DILL2_TEXT_WXMANAGEPHPFILESDIALOG_WXBUTTON_RENAMEPHPFILE_WXDIALOG_MESSAGE", "Please type in a new valid filename to rename the selected file." );
define( "DILL2_TEXT_WXMANAGEPHPFILESDIALOG_WXBUTTON_RENAMEPHPFILE_WXDIALOG_CAPTION", "Rename an existing PHP file." );
