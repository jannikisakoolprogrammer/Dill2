...
define(
	...
	"SSH (SFTP) private key:");
define(
	"DILL2_LABEL_WXSTATICTEXT_SFTP_PRIVATEKEY_PASSPHRASE",
	"SSH (SFTP) private key passphrase:");
define(
...
define(
	...
	"Upload to webserver absolute path (FTPS)");
define(
	"DILL2_LABEL_WXSTATICTEXT_FTPS_WEBSERVER_IP_ADDRESS",
	"The IP address of the webserver (FTPS).");
define(
